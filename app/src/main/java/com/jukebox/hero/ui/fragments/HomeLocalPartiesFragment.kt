 ...
 * [HomeLocalPartiesFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [HomeLocalPartiesFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class HomeLocalPartiesFragment : Fragment() {
...
//        svParties.visibility = View.VISIBLE
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
                HomeLocalPartiesFragment().apply {
